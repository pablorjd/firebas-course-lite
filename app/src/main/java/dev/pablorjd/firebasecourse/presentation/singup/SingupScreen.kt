...
import dev.pablorjd.firebasecourse.ui.theme.SelectedField
import dev.pablorjd.firebasecourse.ui.theme.UnselectedField

@Composable
fun SingupScreen(auth: FirebaseAuth, navigateToHome: () -> Unit) {
    ...
    Column(
        ...
        Button(onClick = {
            auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener { task ->
                    Log.i("Auth", "credenciales $email $password")
